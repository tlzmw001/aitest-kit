...
3. 用例设计：在 `test_workspace/cases/{module}/` 编写业务、边界和异常用例。
4. profile/fixture：在 `test_workspace/tests/fixtures/` 增加模块 fixture 和 codegen profile。
...
- `codegen_profile_{module}.md` 与模块 fixture 同目录。
