...
`开发文档 -> 测试知识库 -> Markdown suite -> Module Harness/profile -> codegen -> pytest 执行 -> 修正与沉淀`
...
- `test_workspace/targets/` — target registry；每个 module 的 module.yaml/profile.md/fixture.py/harness.py 共置于 module package
