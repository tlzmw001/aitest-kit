"""Calibration module Harness for coupon_system tests."""
...
class CalibrationHarness:
    ...
    def run_http_calibration(
        ...
        *,
        ...
        body = self._request_body(resource_key=resource_key, overrides=request_overrides)
    ...
    def _prepare_runtime(
        ...
        *,
        ...
        strategy_id = self._strategy_id(resource_key)
    ...
    def _write_calibration_files(
        ...
        *,
        ...
        case_root = Path(self._temp_dir.name) / self._safe_name(resource_key)
    ...
    def _request_body(self, *, resource_key: str, overrides: dict[str, Any] | None = None) -> dict[str, Any]:
        safe = self._safe_name(resource_key).lower()
        body = {
            "user_id": f"u_{safe}",
            "scene_name": "game",
            "device": "mobile",
    ...
    def _strategy_id(self, resource_key: str) -> str:
        return f"aitest_{self._safe_name(resource_key).lower()}"
