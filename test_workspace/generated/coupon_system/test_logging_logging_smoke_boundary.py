...
class TestLoggingBoundary:
    ...
    def test_tc_log_010(self, setup_logging):
        ...
        try:
            ...
            result = harness.run_http_with_logs(user_id="u_log_010", req_id="req-log-010", external=0, items=[{"item_id": "COUPON_LOG_BOUNDARY_001", "coupon_type": "discount", "value": 80, "min_spend": 5000, "expire_days": 7}])
