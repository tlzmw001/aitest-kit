# Auto-generated from test_workspace/suites/coupon_system/feature_scoring_smoke/boundary.md
...
class TestFeatureScoringBoundary:
    ...
    @pytest.mark.manual
    def test_tc_feat_004(self):
        """TC-FEAT-004：用户特征 key 不存在时静默省略"""
        __tc_meta__ = {
            "tc_id": "TC-FEAT-004",
            "module": "feature_scoring",
            "category": "boundary",
            "source": "test_workspace/suites/coupon_system/feature_scoring_smoke/boundary.md",
