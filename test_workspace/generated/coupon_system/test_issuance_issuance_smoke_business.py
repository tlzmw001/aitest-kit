# Auto-generated from test_workspace/suites/coupon_system/issuance_smoke/business.md
...
class TestIssuanceBusiness:
    ...
    def test_tc_issue_001(self, setup_issuance):
        ...
        __tc_meta__ = {
            ...
            "module": "issuance",
            "category": "business",
            "source": "test_workspace/suites/coupon_system/issuance_smoke/business.md",
            "title": "HTTP 正常发放最高分券",
            "priority": "P1",
            "markers": [],
        }
